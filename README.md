...
- [Live Demo Link](file:///Users/AgapeNduwamungu/Microverse%20projects/hello_microverse_project/index.html)
...
- **What are the errors that may occur when you run the program?**

  - There are no errors in this code.

- **Did the linters run properly?**

  - Yes they did after the right config file were added.
